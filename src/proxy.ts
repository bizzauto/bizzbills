...
const publicPaths = ["/auth/signin", "/auth/register", "/api/auth", "/api/setup", "/api/seed-super-admin", "/api/health", "/", "/pricing", "/plans", "/terms", "/privacy", "/contact", "/auth/forgot-password", "/auth/reset-password"];
