  ...
  return (
    <PublicLayout>
      <section className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
        <p className="text-sm uppercase tracking-[0.25em] text-accent-light">Legal</p>
        <h1 className="mt-3 text-3xl font-bold text-default">Terms of Service</h1>
        <p className="mt-2 text-sm text-muted">Last updated: July 2026</p>

        <div className="prose-invert mt-10 space-y-8 text-default leading-7">
          <section>
            <h2 className="text-xl font-semibold text-default">1. Acceptance of Terms</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">2. Description of Service</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">3. Account Registration</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">4. Acceptable Use</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">5. Data &amp; Privacy</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">6. Payment &amp; Subscriptions</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">7. Limitation of Liability</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">8. Changes to Terms</h2>
            <p className="mt-2">
