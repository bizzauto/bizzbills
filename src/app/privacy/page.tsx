  ...
  return (
    <PublicLayout>
      <section className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-3 text-3xl font-bold text-default">Privacy Policy</h1>
        <p className="mt-2 text-sm text-muted">Last updated: July 2026</p>

        <div className="prose-invert mt-10 space-y-8 text-default leading-7">
          <section>
            <h2 className="text-xl font-semibold text-default">1. Information We Collect</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">2. How We Use Your Information</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">3. Data Security</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">4. Data Retention</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">5. Third-Party Services</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">6. Your Rights</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-default">7. Contact</h2>
            <p className="mt-2">
