 ...
 *
 * Public endpoint to list invoices for a portal session.
 * Expects customer name and orgId as query parameters
 * (passed from the portal page after token validation).
 */
