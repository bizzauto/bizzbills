...
const PLANS: PlanDefinition[] = [
  {
    ...
    features: [
      ...
      { label: "BizzAuto Ai watermark on invoices", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Up to 2 users", included: true },
      { label: "Up to 2 devices", included: true },
...
const MOCK_BILLING_HISTORY: BillingEntry[] = [
  { id: "inv-001", date: "2026-07-01", amount: 200, status: "paid", description: "Professional plan - July 2026" },
  { id: "inv-002", date: "2026-06-01", amount: 200, status: "paid", description: "Professional plan - June 2026" },
  { id: "inv-003", date: "2026-05-01", amount: 75, status: "paid", description: "Starter plan - May 2026" },
